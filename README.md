...
**宠物商城**（内嵌于宝贝详情面板的「商城」tab，消耗星星购买，指标恢复上限 100）：

| 分类 | 数量 | 加值范围 | 价格范围 |
|------|------|---------|---------|
| 🍖 食物 | 12 件 | +15 ~ +50 | 5 ~ 17 星 |
| 🧼 洗浴 | 12 件 | +15 ~ +50 | 5 ~ 17 星 |
| 🧸 玩具 | 12 件 | +15 ~ +50 | 5 ~ 17 星 |

商品名沿用 QQ 宠物风格（如「月光饼饼」「温泉溜溜蛋」「棒棒百宝包」「乖乖鼠」等），三类各有平价到高档的梯度。
